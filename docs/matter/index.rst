...
For more information about Matter compatibility, see :ref:`ug_matter_overview_dev_model_support` and `supported Matter features per SoC <Software maturity levels>`_.

See `matter_samples <Matter samples>`_ for the list of available samples, or `Matter Weather Station <Matter Weather Station sample>`_ or `Matter bridge <Matter bridge sample>`_ for specific Matter applications.
