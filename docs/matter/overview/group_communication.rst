...
.. tabs::
   ...
   .. group-tab:: Nodes
      ...
      You need the :ref:`CHIP Tool <ug_matter_gs_tools_chip>` and the `Matter light bulb sample`_ sample to run through this use case.
...
.. tabs::
   ...
   .. group-tab:: Nodes
      ...
      * The `Matter light bulb sample`_
      * The `Matter light switch sample`_
